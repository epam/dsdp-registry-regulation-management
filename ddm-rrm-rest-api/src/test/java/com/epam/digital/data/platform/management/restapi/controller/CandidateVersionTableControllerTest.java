...
import com.epam.digital.data.platform.management.restapi.exception.FileValidatorErrorMessageTitle;
  ...
  class CandidateVersionTableListTablesControllerTest {
    ...
    void getTablesTest() {
      ...
      var expectedTablesResponse = TableShortInfoDto.builder()
          ...
          .build();
      Mockito.doReturn(true).when(buildStatusService)
          .isSuccessCandidateVersionBuild(versionCandidate);
    ...
    void getTable_versionCandidateNotFound() {
      ...
      Mockito.doThrow(VcsChangeNotFoundException.class).when(versionManagementService)
      ...
      mockMvc.perform(
          ...
          jsonPath("$.messageKey").doesNotHaveJsonPath(),
          content().contentType(MediaType.APPLICATION_JSON)
      );
    ...
    void getTable_registryDataBaseConnectionException() {
      ...
      Mockito.doReturn(false).when(buildStatusService)
          .isSuccessCandidateVersionBuild(versionCandidate);
    ...
    void getTableNotFoundException() {
      ...
      mockMvc.perform(
          ...
          jsonPath("$.messageKey").value(
              is(FileValidatorErrorMessageTitle.TABLE_NOT_FOUND_EXCEPTION.getMessageKey())),
          content().contentType(MediaType.APPLICATION_JSON)
      );
