...
public class CandidateVersionBusinessProcessesController {
  ...
  private static final String FINISHED_GETTING_BUSINESS_PROCESS_FROM_VERSION_CANDIDATE = "Finished getting business process {} from {} version candidate";
  ...
  public ResponseEntity<String> createBusinessProcess(
    ...
    var response = businessProcessService.getProcessContent(businessProcessName,
        versionCandidateId);
    log.info(FINISHED_GETTING_BUSINESS_PROCESS_FROM_VERSION_CANDIDATE, businessProcessName,
        versionCandidateId);
