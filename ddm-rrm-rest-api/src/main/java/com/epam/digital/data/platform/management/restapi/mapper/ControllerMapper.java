...
public interface ControllerMapper {
  ...
  default List<Validation> toValidations(Map<String, Integer> labels) {
    ...
    if (labels.get(VERIFIED_LABEL) != null) {
      builder.result(STATUSES.get(labels.get(VERIFIED_LABEL)));
    } else {
      builder.result(ResultValues.PENDING);
    }
  ...
  I18nDetailsShort toI18nDetailsShort(I18nInfoDto dto);

  List<I18nDetailsShort> toI18nDetailsShortList(List<I18nInfoDto> dtos);
}
