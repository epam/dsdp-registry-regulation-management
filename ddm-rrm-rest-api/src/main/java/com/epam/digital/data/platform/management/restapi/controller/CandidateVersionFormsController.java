...
public class CandidateVersionFormsController {
  ...
  private static final String FINISHED_GETTING_FORM_FROM_VERSION_CANDIDATE = "Finished getting {} form from {} version candidate";
  ...
  public ResponseEntity<String> formCreate(@RequestBody String form,
    ...
    log.info(FINISHED_GETTING_FORM_FROM_VERSION_CANDIDATE, formName, versionCandidateId);
