...
public interface SettingService {
  ...
  /**
   * Return data about settings changes for certain version
   * @param versionCandidateId version we need to get settings from
   * @return {@link SettingsFileInfoDto} representation of settings file info
   */
  List<SettingsFileInfoDto> getChangedSettingsByVersion(String versionCandidateId);

  /**
   * Rolls back settings file changes for the specific version
   * @param settingsFileName   setting file name
   * @param versionCandidateId version candidate name
   */
  void rollbackSettingsFile(String settingsFileName, String versionCandidateId);
