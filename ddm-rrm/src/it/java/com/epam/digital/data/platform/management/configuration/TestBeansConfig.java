...
public class TestBeansConfig {
  ...
  @Bean
  public I18nService testI18nService() {
  ...
  @Bean
  public VcsPropertiesConfig testGerritPropertiesConfig() {
    return Mockito.mock(VcsPropertiesConfig.class);
  }
  ...
  @Bean
  public ReportService testReportService() {
