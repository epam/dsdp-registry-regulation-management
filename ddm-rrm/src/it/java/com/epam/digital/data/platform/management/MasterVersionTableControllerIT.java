...
public class MasterVersionTableControllerIT extends BaseIT {
  ...
  void initStubs() throws JsonProcessingException {
    ...
    final var lastMergedChangeInfo =
        Map.of(
            ...
            "topic",
            "this is description for master",
            "subject",
            "commit message",
            "submitted",
            ...
            List.of(
                Map.of(
                    "message",
                    "Build Started ... MASTER-Build-registry-regulations ...",
                    "date",
                    timestamp.toString(),
                    "_revision_number",
                    1)),
  ...
  class MasterVersionGetTablesIT {
    ...
    void getTablesTest_noRegistryDataBase() {
      context.dropDataBase(context.getVcsProps().headBranch());
      mockMvc.perform(
          get("/versions/master/tables")
      ).andExpectAll(
  ...
  class MasterVersionGetTableIT {
    ...
    @SneakyThrows
    void getTableTest() {
      context.prepareRegistryDataSource(context.getVcsProps().headBranch(),
    ...
    void getTableTest_tableDoesNotExist() {
      mockMvc.perform(
          ...
          jsonPath("$.details", is(String.format(
              ...
              context.getVcsProps().headBranch())))
      );
    }
