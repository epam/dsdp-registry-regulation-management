...
public interface VersionManagementMapper {
  ...
  EntityChangesInfoDto i18nInfoDtoToChangeInfo(I18nInfoDto dto);

  List<EntityChangesInfoDto> i18nInfoDtosToChangeInfos(List<I18nInfoDto> dtos);

  List<EntityChangesInfoDto> settingsFilesInfoDtoToChangeInfos(List<SettingsFileInfoDto> dtos);
  ...
  @Mapping(target = "description",
      expression = "java(changeInfoDto.getDescription() != null ? changeInfoDto.getDescription() : changeInfoDto.getTopic())")
